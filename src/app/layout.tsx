...
export const metadata: Metadata = {
  metadataBase: new URL(process.env.NODE_ENV == 'development' ? 'http://localhost:3000': "https://rodrigomendez.dev"),
  title: "Rodrigo Méndez - Frontend developer",
  description: "Rodrigo Méndez desarrollador frontend con 10 años de experiencia",
  keywords: "frontend,desarrollador,guadalajara,zapopan,jalisco,backend,fullstack,react,native",
  icons: "favicon.ico",
  twitter: {
