...
const Post = ({ post }: Props) => {
  ...
  return (
    <div className="pb-10 w-full mt-10">
      <span className=" text-sm pl-5 md:pl-0">{currentDate}</span>
      ...
      <div className="pl-5 pt-5 flex flex-wrap gap-1 w-full  md:pl-0">
        {post?.fields.tags.map((tag) => (
          <span key={tag} className="text-sm px-1 py-1 rounded-lg">
            #{tag}
          </span>
        ))}
      </div>
