  ...
  return (
    <div className="pb-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 ">
        ...
        <div>
          <p className={`${muslish.className} `}>
            Soy desarrollador de software con más de 10 años de experiencia, he
            trabajo en diferentes tecnologías tanto frontend como backend.
          </p>
          <p className={`${muslish.className} `}>
            Actualmente me enfoco en trabajar proyectos frontend con React como
            tecnología principal. También en el desarrollo mobile con React
            Native.
          </p>
          <p className={`${muslish.className} `}>
